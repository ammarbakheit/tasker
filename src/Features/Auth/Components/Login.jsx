            ...
            <div className="relative bg-indigo-100 rounded-lg shadow static">
              ...
              <div className="max-w-md pb-4 pt-14 px-6">
                ...
                <div className="my-2">
                  ...
                  <input type="password" id="password" onChange={(e) => handlePassword(e)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                </div>
              ...
              <div className="flex justify-between items-center p-6 space-x-2 rounded-b border-t border-gray-200  ">
                <div className="grow w-full">
                  <button data-modal-toggle="small-modal" type="submit" className="text-white w-full bg-indigo-700
